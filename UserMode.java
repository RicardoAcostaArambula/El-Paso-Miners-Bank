...
class UserMode implements BankMode {
    @Override
    public void enterMode(HashMap<String, Customer> users_by_name){
        System.out.println("Entering User Mode...");
        performTransaction(users_by_name);
    }
    @Override
    public void performTransaction(HashMap<String, Customer> users_by_name){
